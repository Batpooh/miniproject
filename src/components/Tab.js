  ...
  return (
    <Table bordered className="white">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row">04</th>
          <img src="https://i.pinimg.com/originals/22/18/b6/2218b66a5f9161ec2955678ff543900d.jpg" height = "250" width = "400"></img>
          ...
          <td id="info">The Kel-Tec KSG is a bullpup 12-gauge pump-action shotgun designed by Kel-Tec. It has two tube magazines which the user of the gun can switch between manually.[2] Each tube holds up to seven 2.75-inch (70 mm) 12-gauge shotshells or six 3-inch (76 mm) shotshells. Kel-Tec has also introduced a larger variant, called the KSG25, which holds 24+1 rounds to the originals 14+1 rounds</td>
        </tr>

        <tr>
          <th scope="row">05</th>
          <img src="https://upload.wikimedia.org/wikipedia/commons/f/fe/Beretta_92S.jpg" height = "250" width = "400"></img>
          ...
          <td id="info">The Beretta 92 is a series of semi-automatic pistols designed and manufactured by Beretta of Italy. It was designed in 1972 and production of many variants in different calibers continues to the present day. It is most famous for replacing the M1911 .45 ACP pistol as the standard sidearms of the United States armed forces in 1985 as the M9 pistol.</td>
        </tr>
      </tbody>
    </Table>
